        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Purchased Stocks</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
                        ...
                        <table class="table table-bordered table-striped table-vcenter">
                            ...
                            @foreach($p_stocks as $item)
                                <tr>
                                    ...
                                    <td>@convert($item->amount) {{ $item->user->currency }}</td>
                                    <td>
                                        {!! $item->status() !!}
                                    </td>
                                    <td class="text-center">
...
{{--                                            </a>--}}
                                            ...
                                            <form method="POST" action="{!! route('admin.deletePurchasedStock', $item->id) !!}" accept-charset="UTF-8">
