        ...
        <div class="nk-content-body">
            ...
            <div class="nk-block">
                ...
                <div class="nk-data data-list">
                    ...
                    <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                        <div class="data-col">
                            ...
                            <span class="data-value">{{ $user->date_of_birth ? : "Not add yet" }}</span>
                        </div>
                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                    </div><!-- .data-item -->
                    <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit" data-tab-target="#address">
                        <div class="data-col">
                            ...
                            <span class="data-value">{{ $user->address ? : "Address Not Set" }},<br>{{ $user->state }}, {{ $user->country }}</span>
                        </div>
                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                    </div><!-- .data-item -->
                    <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit" data-tab-target="#address">
                        <div class="data-col">
                            ...
                            <span class="data-value">{{ $user->telegram ? : "Address Not Set" }}</span>
                        </div>
                        <div class="data-col data-col-end"><span class="data-more"><em class="icon ni ni-forward-ios"></em></span></div>
                    </div><!-- .data-item -->
                </div><!-- .nk-data -->
                <div class="nk-data data-list">
                    ...
                    <div class="data-item">
                        <div class="data-col">
                            <span class="data-label">Base Currency</span>
                            <span class="data-value">{{ $user->currency  }}</span>
                        </div>
                        <div class="data-col data-col-end"><a data-bs-toggle="modal" href="#profile-edit" class="link link-primary">Change Currency</a></div>
                    </div><!-- .data-item -->
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="full-name" name="name" value="{{ old('name', optional($user)->name) }}" placeholder="Enter Full name">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="display-name">Phone Number</label>
                                        <input type="text" class="form-control form-control-lg" id="display-name" name="phone" value="{{ old('phone', optional($user)->phone) }}" placeholder="Phone Number">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="phone-no">Telegram</label>
                                        <input type="text" class="form-control form-control-lg" id="phone-no" name="telegram" value="{{ old('telegram', optional($user)->telegram) }}" placeholder="Telegram">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="birth-day">Date of Birth</label>
                                        <input type="text" class="form-control form-control-lg date-picker" id="birth-day" name="date_of_birth" value="{{ old('date_of_birth', optional($user)->date_of_birth) }}" placeholder="Enter your BirthDay">
                                    </div>
                                </div>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="address-l2" name="city" value="{{ old('city', optional($user)->city) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="address-county" name="country" class="form-control js-select2">
